...
if __name__ == "__main__":
    ...
    afs_raw_sample = pd.read_parquet(
        "s3://open-jobs-lake/job_quality/early_years/evaluation_sample/job_ads_by_sector_region_sample_size_19896.parquet"
    )
    ...
    for i, key in tqdm(enumerate(s3_keys[args.start_index :])):
        ...
        save_to_s3(
            BUCKET_NAME,
            temp_df,
            f"job_quality/early_years/evaluation_sample/metadata_interim_production_{args.production}/job_ads_by_sector_region_sample_size_19896_metadata_chunk_{i+args.start_index}.parquet",
        )
    ...
    save_to_s3(
        BUCKET_NAME,
        master_df,
        f"job_quality/early_years/evaluation_sample/job_ads_by_sector_region_sample_size_19896_metadata_production_{args.production}.parquet",
    )
